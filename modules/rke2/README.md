...
- VMs/Serveurs provisionnés (Proxmox, VMware, bare-metal, cloud)
- Configuration réseau adaptée à votre environnement
- DNS configuré pour `rancher.homelab.local` (ou votre domaine)
...
- [Documentation Rancher](https://rancher.com/docs/) - Documentation officielle Rancher
- [Documentation RKE2](https://docs.rke2.io/) - Documentation officielle RKE2
